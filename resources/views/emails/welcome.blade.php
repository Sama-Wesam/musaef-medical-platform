...
<head>
    ...
    <title>مرحباً بك في منصة مسعف</title>
    <style>
        ...
        .header { background-color: #e63946; padding: 25px; text-align: center; color: #ffffff; }
        ...
        .badge { display: inline-block; padding: 4px 12px; background-color: #eef2f5; color: #e63946; border-radius: 20px; font-weight: bold; font-size: 14px; }
    </style>
</head>
<body>
    <div class="card">
