...
<head>
    ...
    <title>تأكيد التبرع بالدم</title>
    <style>
        ...
        .header { background-color: #2a9d8f; padding: 25px; text-align: center; color: #ffffff; }
        .header h1 { margin: 0; font-size: 22px; }
        .content { padding: 30px; color: #333333; line-height: 1.6; }
        .summary { background: #e8f5e9; padding: 15px; border-radius: 8px; margin: 20px 0; }
        .points { color: #2a9d8f; font-weight: bold; font-size: 18px; }
...
<body>
    <div class="card">
        <div class="header">
            <h1>شكراً لبطولتك! ❤️</h1>
        </div>
        <div class="content">
            <p>عزيزي <strong>{{ $donorName }}</strong>،</p>
            <p>تم إتمام وتأكيد عملية التبرع بالدم بنجاح. مساهمتك القيمة تمنح أملًا جديدًا للحياة.</p>
            ...
            <p>تمت إضافة النقاط إلى حسابك ويمكنك استبدالها عبر مكافآت المنصة.</p>
        </div>
        <div class="footer">
            &copy; {{ date('Y') }} منصة مسعف الطبية - معاً لإنقاذ الأرواح
        </div>
    </div>
</body>
</html>
