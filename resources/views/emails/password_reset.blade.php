...
<head>
    ...
    <style>
        ...
        .btn { display: inline-block; padding: 12px 28px; background-color: #0d6efd; color: #ffffff !important; text-decoration: none; border-radius: 6px; font-weight: bold; margin-top: 15px; }
...
<body>
    <div class="card">
        ...
        <div class="content">
            ...
            <p style="margin-top: 25px; font-size: 13px; color: #718096;">إذا لم تطلب إعادة تعيين كلمة المرور، يمكنك تجاهل هذا البريد وسيظل حسابك آمناً.</p>
        </div>
        <div class="footer">
