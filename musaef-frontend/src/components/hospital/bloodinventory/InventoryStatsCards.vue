    ...
    <div class="col-12 col-sm-6 col-xl-3">
      <div class="card border-0 shadow-sm p-3 rounded-4 bg-white text-center h-100 position-relative">
        <div class="d-flex justify-content-between align-items-center mb-1">
          ...
          <img src="@/assets/images/Frame 2147225613.png" alt="إجمالي الوحدات" class="stat-img" />
        </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3">
      <div class="card border-0 shadow-sm p-3 rounded-4 bg-white text-center h-100 position-relative">
        <div class="d-flex justify-content-between align-items-center mb-1">
          ...
          <img src="@/assets/images/Frame 2147225866.png" alt="الوحدات الصالحة" class="stat-img" />
        </div>
        <div class="text-center">
    ...
    <div class="col-12 col-sm-6 col-xl-3">
      <div class="card border-0 shadow-sm p-3 rounded-4 bg-white text-center h-100 position-relative">
        <div class="d-flex justify-content-between align-items-center mb-1">
          ...
          <img src="@/assets/images/Frame 2147225868.png" alt="مخزون منخفض" class="stat-img" />
        </div>
        <div class="text-center">
    ...
    <div class="col-12 col-sm-6 col-xl-3">
      <div class="card border-0 shadow-sm p-3 rounded-4 bg-white text-center h-100 position-relative">
        <div class="d-flex justify-content-between align-items-center mb-1">
          ...
          <img src="@/assets/images/Frame 2147225871.png" alt="الحالات الحرجة" class="stat-img" />
        </div>
        <div class="text-center">
