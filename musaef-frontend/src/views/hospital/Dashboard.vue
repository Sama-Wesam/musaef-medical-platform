<template>
  <HospitalLayout>
    <div class="hospital-dashboard container-fluid px-2 px-md-3" :dir="currentLocale === 'ar' ? 'rtl' : 'ltr'">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 mb-md-4 flex-wrap gap-2">
          ...
          <div class="d-flex align-items-center gap-2">
            <span class="badge bg-danger-subtle text-danger px-3 py-2 rounded-pill fs-8 fw-bold">
              <i class="bi bi-exclamation-octagon-fill me-1"></i> {{ t('criticalBadge') }} {{ dashboardData.stats?.critical_cases || 7 }}
            </span>
          </div>
        </div>
